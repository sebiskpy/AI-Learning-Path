...
print("Ostatnia kolumna:", last_column)
print("Podmacierz:\n", sub_matrix)
...
print("Wektor danych:", data)
print("Maska (data > 0):", mask)
print("Dodatnie wartości:", positive_data)
...
print("Ceny przed podatkiem:\n", prices)
print("Podatek do dodania:", tax_increase)
print("Ceny po dodaniu podatku:\n", final_prices)
...
print("Macierz:\n", matrix)
print("Suma kolumn (axis=0):", col_sum)
print("Średnia wierszy (axis=1):", row_mean)
...
result2 = inputs @ weights
print("Wejścia:", inputs)
print("Wagi:", weights)
print("Iloczyn skalarny (dot product):", result)
print("Iloczyn skalarny (operator @):", result2)